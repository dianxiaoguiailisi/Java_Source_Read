...
/**
 * 独立的 XML 应用程序上下文，获取上下文定义文件
 * 从类路径中，将普通路径解释为类路径资源名称
 * 包含包路径（例如“mypackage/myresource.txt”）。适用于
 * 测试工具以及嵌入在 JAR 中的应用程序上下文。
 *
 */
...
/**
	 * 创建一个新的 ClassPathXmlApplicationContext，加载定义
	 * 并自动刷新上下文。
	 * @param configLocation 资源位置
	 * 如果上下文创建失败，则@throws BeansException
	 */
	public ClassPathXmlApplicationContext(String configLocation) throws BeansException {
		this(new String[] {configLocation}, true, null);//构造函数重载，调用另一个构造函数
	}
